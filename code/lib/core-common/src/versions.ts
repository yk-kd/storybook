...
export default {
  ...
  '@storybook/preact': '8.1.5',
  '@storybook/preact-vite': '8.1.5',
  '@storybook/preact-webpack5': '8.1.5',
  '@storybook/preset-create-react-app': '8.1.5',
  '@storybook/preset-html-webpack': '8.1.5',
  '@storybook/preset-preact-webpack': '8.1.5',
  '@storybook/preset-react-webpack': '8.1.5',
  '@storybook/preset-server-webpack': '8.1.5',
  '@storybook/preset-svelte-webpack': '8.1.5',
  '@storybook/preset-vue3-webpack': '8.1.5',
